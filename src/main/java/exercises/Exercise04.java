...
public class Exercise04 implements Command, Previewable {
    // -- Parameters --
    ...
    private mt.ImageTransformer transformer = new ImageTransformer();
    ...
    public static void main(final String... args) throws Exception {
        ...
        PluginInfo<Command> rampInfo = new PluginInfo<Command>(Exercise04.class, Command.class);
        ...
        ij.command().run(Exercise04.class, true);
    }
